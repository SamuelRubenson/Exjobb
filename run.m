...
LES_Params = struct('lookBack', 252:100:952, 'beta', 0.85);
LES = {'LES', LES_Params};
...
outCome = evaluatePerformance(Open(start:end,X), High(start:end,X), Low(start:end,X), Close(start:end,X), Config, assetClasses(X), TF{:}, LES{:});
