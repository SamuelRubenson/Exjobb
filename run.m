...
LES_Params = struct('lambdaMV', 0.3);
LES = {'LES', LES_Params};
...
outCome = evaluatePerformance(Open(start:end,X), High(start:end,X), Low(start:end,X), Close(start:end,X), Config, assetClasses(X), TF{:}, MV{:}, LES{:});
