...
RP_Params = struct('lambda', 1, 'regCoeffs', 10^10);
RP = {'RP', RP_Params};
...
outCome = evaluatePerformance(Open(start:end,X), High(start:end,X), Low(start:end,X), Close(start:end,X), Config, assetClasses(X), TF{:}, MV{:}, RP{:}, RPM{:});
